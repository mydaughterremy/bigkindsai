...
class SearchServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.MSearch = channel.unary_unary(
                '/SearchService/MSearch',
                request_serializer=search__pb2.MSearchRequest.SerializeToString,
                response_deserializer=search__pb2.MSearchResponse.FromString,
                )
...
class SearchServiceServicer(object):
    ...
    def MSearch(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_SearchServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'MSearch': grpc.unary_unary_rpc_method_handler(
                    servicer.MSearch,
                    request_deserializer=search__pb2.MSearchRequest.FromString,
                    response_serializer=search__pb2.MSearchResponse.SerializeToString,
            ),
    }
...
class SearchService(object):
    ...
    def MSearch(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/SearchService/MSearch',
            search__pb2.MSearchRequest.SerializeToString,
            search__pb2.MSearchResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
